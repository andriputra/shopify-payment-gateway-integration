...
exports.accurateWebhookRoutes = accurateWebhookRoutes;
            ...
            if (!record) {
                ...
                record = records.find((r) => {
                    if (orderIdRaw) {
                        ...
                        if (gidTail === orderIdRaw)
                            return true;
                    }
                    if (providerRefRaw && r.providerReference === providerRefRaw)
                        return true;
                    if (orderRefRaw && r.orderReference === orderRefRaw)
                        return true;
                    return false;
                });
                if (record) {
