...
function createJsonStorage() {
    ...
    return {
        ...
        systemStatus: async () => {
            const [storeConfigs, shopifyTokens, paymentSessionContexts, paymentRedirectCount, complianceRequests] = await Promise.all([
                storeRepo.list(),
                tokenRepo.list(),
            ...
            return {
                ...
                counts: {
                    ...
                    paymentRedirects: paymentRedirectCount,
